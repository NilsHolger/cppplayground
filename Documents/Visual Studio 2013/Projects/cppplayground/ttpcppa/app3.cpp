...
auto main() -> int
{
	...
	NeuralNetwork myNeuralNetwork(topology);
	...
	while (!trainData.isEof()) {
		...
		myNeuralNetwork.feedForward(inputVals);

		myNeuralNetwork.getResults(resultVals);
		...
		myNeuralNetwork.backProp(targetVals);

		cout << "neuralnetwork recent average error: "
			<< myNeuralNetwork.getRecentAverageError() << '\n';
	}
